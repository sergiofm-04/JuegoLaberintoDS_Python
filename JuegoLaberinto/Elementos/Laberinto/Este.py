...
class Este(Orientacion):
    ...
    def default(cls):
        """
        Devuelve la única instancia de Este.
    ...
    def __new__(cls, *args, **kwargs):
        """
        Evita la creación de nuevas instancias.
        """
        if cls._unica_instancia is None:
            cls._unica_instancia = super(Este, cls).__new__(cls, *args, **kwargs)
        return cls._unica_instancia

    def __init__(self):
        """
        Constructor protegido para evitar múltiples inicializaciones.
        """
